            ...
            <ul class="navbar-nav">
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu--subcategory">
                  <a href="#" class="dropdown-item">Название подкатегории 1</a>
                  <a href="#" class="dropdown-item">Подкатегория 2</a>
                  <a href="#" class="dropdown-item">Название подкатегории 3</a>
                  <a href="#" class="dropdown-item">Подкатегория 4</a>
                  <a href="#" class="dropdown-item">Название подкатегории5</a>
                  <a href="#" class="dropdown-item">Подкатегория 6</a>
                  <a href="#" class="dropdown-item">Название подкатегории 7</a>
                  <a href="#" class="dropdown-item">Подкатегория 8</a>
                  <a href="#" class="dropdown-item">Название подкатегории 9</a>
                  <a href="#" class="dropdown-item">Подкатегория 10</a>
                  <a href="#" class="dropdown-item">Название подкатегории 11</a>
                  <a href="#" class="dropdown-item">Подкатегория 12</a>
                </div>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link nav-link--all dropdown-toggle" href="#">
                  Все категории
                </a>
                <div class="dropdown-menu dropdown-menu--subcategory"></div>
              </li>
            </ul>
          </div>
                      ...
                      <div class="offer-card">
                        ...
                        <div>
                          <div class="offer-card__desc text-center">
                            ...
                            <p>
                              50% на летние и пляжные аксессуары
                            </p>
                          </div>
                          <div
                            class="offer-card__link text-center text-md-left"
                          >
                      ...
                      <div class="card-categories">
                        ...
                        <div class="card-categories__img">
                          <picture>
                            <source
                              type="image/webp"
                              srcset="img/product-category.webp"
                            />
                            <img
                              src="img/product-category.jpg"
