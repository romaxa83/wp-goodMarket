...
class SaveImportController extends BaseController {
    ...
    public function actionStartSave() {
        ...
        //$this->importService->writeJson($combine_category, $absolutePath . '/combine_category.json');
    ...
    public function actionEdit() {
        ...
        $characters_id = $this->saveNewCharacteristic(
                $post['characteristic'] ?? null, $group_id ?? null);
        ...
        $this->importService->writeJson(array_combine(array_values($this->importService->getCategoryKeys(Yii::$app->cache->get('categoryXml'))), array_values($post['categoryProsto'])), $absolutePath . '/combine_category.json');
