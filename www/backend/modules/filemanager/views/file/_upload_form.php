...
<?= Html::beginTag('div', $context->options); ?>
    ...
    <div class="row fileupload-buttonbar">
        <div class="col-lg-7">
            <a href="<?= Url::to(['file/filemanager']) ?>" class="btn btn-primary">
                <span>Назад</span>
            </a>
            ...
            <a class="btn btn-danger delete delete-all d-none">
                <i class="glyphicon glyphicon-trash"></i>
                <span><?= Yii::t('fileupload', 'Delete') ?></span>
            </a>
<!--            <input type="checkbox" class="toggle file-check d-none">-->
    ...
    <table role="presentation" class="table table-striped table-images"><tbody class="files"></tbody></table>
    <div class="col-md-12">
        <a class="btn btn-primary start start-all d-none">
            <i class="glyphicon glyphicon-upload"></i>
            <span><?= Yii::t('fileupload', 'Start upload') ?></span>
        </a>
        <a class="btn btn-warning cancel cancel-all d-none">
